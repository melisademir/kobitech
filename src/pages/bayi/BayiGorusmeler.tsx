...
const mockConversations = [
  { id: 1, name: "Demo İşletme (KOBİ)", lastMessage: "POS hakkında bilgi almak istiyorum", time: "14:30", unread: 2 },
  { id: 2, name: "ABC Tekstil (KOBİ)", lastMessage: "Teklifi onayladık", time: "Dün", unread: 0 },
  { id: 3, name: "Admin", lastMessage: "Yeni müşteri atandı", time: "2 gün önce", unread: 0 },
];

const mockMessages = [
  { id: 1, sender: "them", text: "Merhaba, POS çözümünüz hakkında bilgi almak istiyorum.", time: "14:30" },
  { id: 2, sender: "me", text: "Tabii, Param POS ile temassız ödeme, kampanya yönetimi ve anlık raporlama sunuyoruz.", time: "14:32" },
  { id: 3, sender: "them", text: "Kurulum süresi ne kadar?", time: "14:33" },
  { id: 4, sender: "me", text: "Kurulum 2 gün içinde tamamlanır. Size özel bir teklif hazırlayabilirim.", time: "14:35" },
];

const BayiGorusmeler = () => {
