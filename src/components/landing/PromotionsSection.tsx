...
const cards = [
  {
    ...
    icon: MessageSquare,
    image: promoAiAgent,
    overlay: "linear-gradient(180deg, rgba(220,230,245,0.88) 0%, rgba(200,215,240,0.75) 50%, rgba(180,200,235,0.85) 100%)",
    textColor: "hsl(220,40%,18%)",
    subtitleBg: "rgba(99,102,241,0.15)",
    subtitleColor: "#4F46E5",
    subtitleBorder: "rgba(99,102,241,0.3)",
    descColor: "rgba(30,30,60,0.6)",
    btnBg: "rgba(0,0,0,0.07)",
    btnBorder: "rgba(0,0,0,0.12)",
    btnColor: "hsl(220,40%,22%)",
  },
  {
