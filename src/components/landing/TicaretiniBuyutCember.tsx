...
export default function TicaretiniBuyutCember() {
  ...
  const titleTop = useTransform(smoothMorph, [0, 0.8], [33, 4]);
        ...
        <div className="absolute inset-0 z-10">
          {CATEGORIES.map((category, i) => {
            ...
            if (introPhase === "scatter") {
              ...
              const circlePos = { x: Math.cos(circleRad) * circleRadius, y: Math.sin(circleRad) * circleRadius - 60, rotation: circleAngle + 90 };
