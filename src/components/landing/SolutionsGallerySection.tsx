...
const galleryItems: GalleryItem[] = [
  ...
  { common: "Teşviklerden Yararlan", binomial: "Hibe & Destek", description: "İşletmenize en uygun hibe ve teşvik programlarını uzman danışmanlarımızla birlikte saptayın. Doğrudan ilgili kurumlarla bir araya getiriyoruz.", tags: ["Hibe Danışmanlığı", "Teşvik Programları"], photo: { url: tabTesvik, text: "Teşvikler", by: "DigitalHub" } },
  { common: "Globale Açıl", binomial: "Uluslararası Ticaret", description: "Türkiye'nin en güçlü iş dünyası kuruluşlarının vizyonuyla ticaretinizi sınırların ötesine taşıyın. DigitalHub ile doğru pazara, doğru strateji ve tam dijital bir ekosistemle adım atın.", tags: ["İhracat Danışmanlığı", "Uluslararası Pazarlar"], photo: { url: tabGlobal, text: "Global ticaret", by: "DigitalHub" } },
];
