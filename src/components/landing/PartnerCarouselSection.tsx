...
const PartnerCarouselSection = () => {
  ...
  return (
    <section className="pt-16 md:pt-24 pb-16 md:pb-20" onMouseEnter={pauseAutoSlide} onMouseLeave={resumeAutoSlide}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p
            className="text-muted-foreground mt-3 mx-auto text-sm md:text-base md:whitespace-nowrap"
